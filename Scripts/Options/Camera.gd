...
# TODO: add FOV.
export var camera_chase_offset = 5 		# Is added to bounding box axis value.
export var camera_chase_vert_offset = 2 		# TODO: unique for each ship?
export var camera_chase_tilt_horiz_limit = 40 	# Deg +\-
export var camera_chase_tilt_vert_limit = 20 	# Deg +\-
